...
<body class="bg-custom2 font-poppins antialiased dark:bg-black text-black">
                                    ...
                                    <g id="SVGRepo_iconCarrier">
                                        ...
                                        <g id="Page-1" stroke="none" stroke-width="1" fill="none"
                                            ...
                                            <g id="Icon-Set" sketch:type="MSLayerGroup"
                                                transform="translate(-256.000000, -1139.000000)" fill="#ffffff">
                                                <path
                                ...
                                <tr class="bg-custom4">
                                    <td class="p-2 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-4 font-medium text-gray-800">TAXATION LESSON PLAN 1</div>
                                        </div>
                                    </td>
                                    <td class="p-2 whitespace-nowrap">
                                        <div class="flex items-center">
                                ...
                                <tr>
                                    <td class="p-2 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-4 font-medium text-gray-800">MANAGEMENT ADVISORY SERVICES
                                                LESSON PLAN 1</div>
                                        </div>
                                    </td>
                                    <td class="p-2 whitespace-nowrap">
