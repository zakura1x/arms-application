                        ...
                        <section class="p-8 antialiased">
                            <div class="flex items-center justify-end space-x-6">
                                ...
                                <button id="addfaculty"
                                    class="flex items-center text-white border rounded-lg p-5 w-35 h-8 bg-custom3">
                                ...
                                <svg width="25" height="25" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <g id="SVGRepo_iconCarrier">
                                        ...
                                        <path opacity="0.4"
                                            ...
                                            stroke="#ffffff" stroke-width="1.5" stroke-linecap="round"
                                            stroke-linejoin="round"></path>
                                        <path opacity="0.4" d="M21.4004 15V9" stroke="#ffffff" stroke-width="1.5"
                                            stroke-linecap="round" stroke-linejoin="round"></path>
                                    </g>
                                </svg>
                                ...
                                <tbody class="divide-y divide-gray-100">
                                    @foreach ($faculty as $faculty)
                                        <tr>
                                            ...
                                            <td class="w-1/4 p-2">
                                                <div class="text-left">{{ $faculty->email }}</div>
                                            </td>
                                            <td class="p-2 whitespace-nowrap">
                                                <div class="text-left">
                                                    {{ $faculty->first_name }}{{ $faculty->last_name }}</div>
                                            </td>
                                            <td class="p-2 whitespace-nowrap">
