  ...
  <div class="bg-white rounded-lg shadow-lg max-w-7xl">
    ...
    <div class="p-4">
      <form id="topicForm" action="#" method="#">
        ...
        <input id="topicName" list="topics" placeholder="Enter Topic Name" name="Topics" required class="bg-[#D0D9D3] border-0 rounded-lg text-l shadow w-full h-12 p-5 mb-4 ease-linear transition-all duration-150">
          <datalist id="topics">
            <option value="T1">
            <option value="T2">
          </datalist>
        <div class="flex items-center">
          <div class="w-full mr-2">
            ...
            <input id="moduleName" list="modules" placeholder="Enter Module Name" name="Modules" required class="bg-[#D0D9D3] border-0 rounded-lg text-l shadow w-full h-12 p-5 mb-4 ease-linear transition-all duration-150">
              <datalist id="modules">
                <option value="M1">
                <option value="M2">
              </datalist>
