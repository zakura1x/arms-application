            ...
            <div class="p-8 bg-[#EFF4F6] h-full shadow-lg border">
                                    ...
                                    <g id="SVGRepo_iconCarrier">
                                        ...
                                        <g data-name="Layer 2" id="Layer_2">
                                            <g data-name="E421, Back, buttons, multimedia, play, stop"
                                                ...
                                                <line class="cls-1" x1="352.26" x2="170.43" y1="256"
                                                    y2="256"></line>
                    ...
                    <div class="border-b-8 border-green-700">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                ...
                                <h3 class="font-semibold ml-4">{{ $assessment->name }}</h3>
                            </div>

                            <div class="flex items-center justify-center">

                                <button id="openAssessmentModal"
                                    class="bg-[#42604C] text-white font-medium cursor-pointer m-2 py-2 px-4 rounded-lg focus:outline-none focus:shadow-outline">
                                    <a>Generate Questions</a>
                                </button>

                                <button type="button" class="ml-2 mr-4">
                                    <svg width="30px" height="30px" viewBox="-102.4 -102.4 1228.80 1228.80"
                                        xmlns="http://www.w3.org/2000/svg" fill="#000000">
                                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                ...
                <div id="assessmentModal"
                    ...
                    <div class="bg-white rounded-lg shadow-lg">
                        ...
                        <div class="p-4">
                            <form id="assessmentForm" action="{{ route('ph.assessment-store') }}" method="POST">
                                @csrf
                                ...
                                <div id="parametersContainer">
                                    <div class="flex items-center justify-center">
                                        <div class="flex flex-col mr-4">
                                            ...
                                            <input name="number_of_questions" id="numItems" type="number"
                                                min="1" required
                                                class="bg-[#D0D9D3] border-0 rounded-lg text-l shadow w-full h-12 p-5 mb-2 ease-linear transition-all duration-150">
                                        </div>

                                        <div class="flex flex-col mr-4">
                                            <label for="levelDifficulty"><b>Level of Difficulty</b></label>
                                            <input name="difficulty" id="levelDifficulty" list=difficulty
                                                type="text" required
                                                class="bg-[#D0D9D3] border-0 rounded-lg text-l shadow w-full h-12 p-5 mb-2 ease-linear transition-all duration-150">
                                        ...
                                        <div class="flex flex-col">
                                            ...
                                            <input name="topic" id="topicCovered" type="text" required
                                                class="bg-[#D0D9D3] border-0 rounded-lg text-l shadow w-full h-12 p-5 mb-2 ease-linear transition-all duration-150">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center justify-center space-x-6 p-2">
                                    <button type="button" id="closeAssessmentModal"
                                        class="close font-medium py-2 px-4 rounded-lg focus:outline-none focus:shadow-outline">CANCEL</button>
                                    <div id="generateButton"
                                        ...
                                        <svg width="19" height="19" viewBox="0 0 19 19" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M5.72003 1.72868C2.84265 3.13084 0.860031 6.08394 0.860031 9.50011C0.860031 14.2719 4.72829 18.1401 9.50003 18.1401C14.2718 18.1401 18.14 14.2719 18.14 9.50011C18.14 4.72837 14.2718 0.860107 9.50003 0.860107V11.6601"
                                                stroke="white" stroke-width="1.2" />
                                            <path d="M13.28 7.88013L9.50003 11.6601L5.72003 7.88013" stroke="white"
                                                stroke-width="1.2" />
                                        </svg>
