            ...
            <div id="main-content" class="h-screen flex-1 transition-all duration-300 ease-in-out">
              ...
              <section class="bg-[#EFF4F6] p-4 antialiased">
                <div class="flex items-center justify-center space-x-6">
                  <button class="flex items-center text-white rounded-lg p-5 w-24 h-8 bg-[#42604C]">
                  ...
                  <button class="flex items-center text-white rounded-lg p-5 w-35 h-8 bg-[#42604C]">
