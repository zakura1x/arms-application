                                ...
                                <table class="table-auto w-full border">
                                    ...
                                    <tbody class="text-sm divide-y divide-gray-100">
                                        <tr>
                                            <td class="w-1/4 p-2">
                                                <div class="flex items-center">
                                                    <div class="ml-4 font-medium text-gray-800">What is the tax value
                                                        method?</div>
                                                </div>
                                            </td>
                                        ...
                                        <tr class="bg-custom4">
                                            <td class="p-2 whitespace-nowrap">
                                                <div class="flex items-center">
                                                    <div class="ml-4 font-medium text-gray-800">Where did the tax value
                                                        method come from?</div>
                                                </div>
                                            </td>
                                            <td class="p-2 whitespace-nowrap">
                                                <div class="flex items-center">
                                        ...
                                        <tr>
                                            <td class="p-2 whitespace-nowrap">
                                                <div class="flex items-center">
                                                    <div class="ml-4 font-medium text-gray-800">Why introduce the tax
                                                        value method?</div>
                                                </div>
                                            </td>
                                            <td class="p-2 whitespace-nowrap">
                ...
                <section class="bg-custom2 p-4 antialiased">
                    <div class="flex items-center justify-center space-x-6">
                        ...
                        <button class="flex items-center text-white rounded-lg p-5 w-35 h-8 bg-custom3">
                            <svg width="20" height="20" viewBox="-4 0 60 60" version="1.1"
                                ...
                                <g id="SVGRepo_iconCarrier">
                                    ...
                                    <defs> </defs>
                                    <g id="People" stroke="none" stroke-width="1" fill="none"
                                        fill-rule="evenodd">
                                        <g id="Icon-3" transform="translate(-4.000000, 0.000000)" fill="#ffffff">
                                            <path
