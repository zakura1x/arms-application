            ...
            <div class="p-8 bg-custom2 h-full shadow-lg border">
                ...
                <div class="overflow-x-auto h-screen bg-custom1">
                    <div class="p-8">
                        <form id="ldpForm" action="#" method="#">
                            <div class="flex items-center">
                                <div class="w-1/2 mr-5">
                                    ...
                                    <input id="lessontitle" type="text" placeholder="Enter Lesson Plan Title"
                                        required
                                        class="bg-custom2 border-0 rounded-lg text-l shadow w-full h-12 p-5 mb-4 ease-linear transition-all duration-150">
                                </div>
                                <div class="w-1/2">
                                    <label for="subject"><b>Subject</b></label>
                                    <input id="subject" list="subjects" placeholder="Enter Subject" name="Subjects"
                                        required
                                        class="bg-custom2 border-0 rounded-lg text-l shadow w-full h-12 p-5 mb-4 ease-linear transition-all duration-150">
                            ...
                            <div class="flex items-center">
                                <div class="w-1/2 mr-5">
                                    <div
                                        class="flex items-center justify-center rounded-lg bg-custom2 border-dashed border-2 border-black border-opacity-50">
                                        <input id="pdffiles" type="file"
                            ...
                            <div class="bg-white rounded-lg shadow-lg w-1/2">
                                ...
                                <div class="p-4">
                                    <form id="topicForm" action="#" method="#">
                                        ...
                                        <input id="topicTitle" type="text" placeholder="" required
                                            class="bg-custom1 border-0 rounded-lg text-l shadow w-full h-12 p-5 ease-linear transition-all duration-150">
                                        ...
                                        <div class="flex items-center justify-end space-x-6 p-2">
                                            ...
                                            <div
                                                class="flex items-center bg-custom3 text-white font-medium py-2 px-4 rounded-lg focus:outline-none focus:shadow-outline">
                        ...
                        <div id="newButtonContainer" class="flex flex-wrap mt-4 mb-4"></div>
                        <!-- Container for dynamically created buttons -->

                        <div id="expansionPanels" class="space-y-4 space-x-4"></div>
        ...
        saveButton.addEventListener('click', function(event) { //LDP upper Part
            ...
            if (form.checkValidity()) {
                ...
                if (!document.getElementById('openModal')) { //Showing Topic Modal
                    ...
                    newButton.className =
                        'bg-custom3 text-white font-medium py-2 px-4 rounded-lg focus:outline-none focus:shadow-outline';
