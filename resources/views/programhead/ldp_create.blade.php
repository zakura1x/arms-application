            ...
            <div id="main-content" class="h-screen flex-1 transition-all duration-300 ease-in-out">
                <div class="p-8 bg-custom2 h-full shadow-lg border">
                    ...
                    <div class="overflow-x-auto h-screen bg-custom1">
                        <div class="p-8">
                            <form action="{{ route('ph.add-ldp') }}" method="POST">
                                @csrf
                                <div class="flex items-center">
                                    <div class="w-1/2 mr-5">
                                        <label for="plan_name"><b>Lesson Plan Title</b></label>
                                        <input name="plan_name" id="lessontitle" type="text"
                                    ...
                                    <div class="w-1/2">
                                        ...
                                        <input name="subject_name" id="subject" list="subject_name"
