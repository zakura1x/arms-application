          ...
          <div class="p-8">
              <div class="flex items-center">
                <div class="w-1/2 mr-5">
                  ...
                  <input id="lessontitle" type="text" disabled class="bg-custom2 border-0 rounded-lg text-l shadow w-full h-12 p-5 mb-4 ease-linear transition-all duration-150" value="">
                </div>
                <div class="w-1/2">
                  <label for="subject"><b>Subject</b></label>
                  <input id="subject" list="subjects"disabled class="bg-custom2 border-0 rounded-lg text-l shadow w-full h-12 p-5 mb-4 ease-linear transition-all duration-150" value="">
                </div>
              </div>

            <div class="border-2 border-green-700 mt-4 mb-4"></div>

            <button id="openModal" class="bg-custom3 text-white font-medium m-2 py-2 px-4 rounded-lg focus:outline-none focus:shadow-outline">
            ...
            <div class="flex items-end justify-end space-x-6 p-4 w-full">
              <button type="button" id="backButton" class="close bg-custom1 font-medium py-2 px-4 rounded-lg focus:outline-none focus:shadow-outline cursor-pointer">
                CANCEL
              </button>
              <div class="flex items-center justify-center bg-custom3 text-white font-medium py-2 px-4 rounded-lg focus:outline-none focus:shadow-outline cursor-pointer">
                ...
                <button type="submit" class="ml-2" id="saveButton">
                  SAVE
                </button>
              </div>
            </div>
        ...
        <div class="bg-white rounded-lg shadow-lg w-1/2">
          ...
          <div class="p-4">
            <form id="topicForm" action="#" method="#">
              ...
              <input id="topicTitle" type="text" required class="bg-custom1 border-0 rounded-lg text-l shadow w-full h-12 p-5 mb-4 ease-linear transition-all duration-150">
              <label for="topicDescription"><b>Topic Description</b></label>
              <input id="topicDescription" type="text" required class="bg-custom1 border-0 rounded-lg text-l shadow w-full h-12 p-5 ease-linear transition-all duration-150">
              ...
              <div class="flex items-center justify-end space-x-6 p-2">
                ...
                <div id="createButton" class="flex items-center bg-custom3 text-white font-medium py-2 px-4 rounded-lg focus:outline-none focus:shadow-outline">
        ...
        <div class="bg-white rounded-lg shadow-lg w-1/2">
            ...
            <div class="p-4">
                <form id="materialForm" action="#" method="#" enctype="multipart/form-data">
                    ...
                    <input id="materialTitle" type="text" required class="bg-custom1 border-0 rounded-lg text-l shadow w-full h-12 p-5 mb-4 ease-linear transition-all duration-150">
                    <input id="materialDescription" type="text" placeholder="Material Description" required class="bg-custom1 border-0 rounded-lg text-l shadow w-full h-12 p-5 mb-4 ease-linear transition-all duration-150">
                    <label for="materialFile"><b>Attach File</b></label>
                    <input id="materialFile" type="file" accept="application/pdf" required class="bg-custom1 border-0 rounded-lg text-l shadow w-full h-15 p-2 ease-linear transition-all duration-150">
