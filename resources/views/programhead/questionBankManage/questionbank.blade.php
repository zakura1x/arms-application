...
<body class="bg-[#EFF4F6] font-poppins text-black">
            ...
            <div id="main-content" class="h-screen flex-1 transition-all duration-300 ease-in-out">
                ...
                <section class="pl-5 pr-5 antialiased h-1/2">
                    <div class="bg-white shadow-lg rounded-lg border border-gray-200 h-full">
                        <header
                            class="flex items-center justify-between bg-[#42604C] text-white border-b border-gray-100">
                                    ...
                                    @foreach ($assessmentQuestions as $question)
                                        <tbody class="text-sm divide-y divide-gray-100">
                                            <tr class="main-row cursor-pointer">
                                                ...
                                                <td class="w-1/4 p-2">
                                                    <div class="flex items-center">
                                                        <div class="font-medium text-gray-800">{{ $question->taxonomy }}
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="p-2 whitespace-nowrap">
                                                    {{-- If $question->is_approved is 1 make it approved else pending --}}
                                                    <div class="flex items center">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            createquestion.addEventListener('click', function() {
                window.location.href = '{{ route('ph.question-create') }}';
            });
        });
    </script>
</body>
