                        ...
                        <div class="bg-white rounded-lg shadow-lg w-1/2">
                            ...
                            <div class="p-8">
                                <form id="classForm" action="{{ route('ph.add-class') }}" method="POST">
                                    @csrf
                                    <input type="text" name="name" id="class" placeholder="Class Name"
                                        required
                                        class="bg-custom1 border-0 rounded-lg text-l shadow w-full h-12 p-5 mb-4 ease-linear transition-all duration-150">
                                    <input type="text" placeholder="Class School Year" name="class_school_year"
                                        id="class_school_year" required
                                        class="bg-custom1 border-0 rounded-lg text-l shadow w-full h-12 p-5 mb-4 ease-linear transition-all duration-150">
